...
const KeyboardComponent = ({ setIsOpen, onInputChange }) => {
    ...
    return (
        <div className="absolute bottom-[40px] left-1/2 -translate-x-1/2 flex flex-col w-[1920px] h-[944px] bg-[#FCEFD6] rounded-[88px] p-[40px] gap-[40px] font-[Roboto-Slab] z-99" style={{ boxShadow: "0px 0px 32px 0px rgba(35, 1, 9, 0.25)" }}>
