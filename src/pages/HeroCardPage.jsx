                                ...
                                <div className="flex gap-x-[40px]">
                                    ...
                                    <div className="flex flex-col gap-[67px] w-[1380px]">
                                        ...
                                        <div className="flex flex-col gap-[20px]">
                                            ...
                                            <span className="text-[28px]/[37px] font-[400] font-[Roboto-Slab] text-[#464444] break-normal">{hero.city ? hero.city : 'Нет данных'}</span>
                                        </div>
                                        <div className="flex flex-col gap-[20px]">
                                    ...
                                    <div className="w-[1380px] flex flex-col gap-[20px] h-[680px] overflow-auto">
                                        ...
                                        <span className="text-[28px]/[37px] font-[400] font-[Roboto-Slab] text-[#464444] break-normal whitespace-pre-line">{hero.additional ? hero.additional : 'Нет данных'}</span>
                                    </div>
                                </div>
                            </div>
